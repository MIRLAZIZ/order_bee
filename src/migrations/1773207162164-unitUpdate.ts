...
export class UnitUpdate1773207162164 implements MigrationInterface {
    name = 'UnitUpdate1773207162164'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`FK_0dce9bc93c2d2c399982d04bef1\` ON \`product\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX \`FK_0dce9bc93c2d2c399982d04bef1\` ON \`product\` (\`category_id\`)`);

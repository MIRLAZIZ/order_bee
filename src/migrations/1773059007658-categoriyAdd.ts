...
export class CategoriyAdd1773059007658 implements MigrationInterface {
    name = 'CategoriyAdd1773059007658'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`product\` CHANGE \`category_id\` \`category_id\` int NOT NULL`);

...
export class ProductEntityUpdate1774888726269 implements MigrationInterface {
    name = 'ProductEntityUpdate1774888726269'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`product\` CHANGE \`max_quantity_notification\` \`max_quantity_notification\` decimal(18,2) NOT NULL`);

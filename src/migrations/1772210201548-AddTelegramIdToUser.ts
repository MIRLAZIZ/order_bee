...
export class AddTelegramIdToUser1772210201548 implements MigrationInterface {
    name = 'AddTelegramIdToUser1772210201548'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`FK_745632f9034cd78ed2fbea6cd1a\` ON \`unit\``);
        await queryRunner.query(`DROP INDEX \`FK_9bbe39ab10e86530296c3340aa3\` ON \`product_price_history\``);
        await queryRunner.query(`DROP INDEX \`FK_5015e2759303d7baaf47fc53cc8\` ON \`sales\``);
        await queryRunner.query(`DROP INDEX \`FK_a0f1ebffae0628aae642b74d505\` ON \`sales\``);
        await queryRunner.query(`DROP INDEX \`FK_5f282f3656814ec9ca2675aef6f\` ON \`sales\``);
        await queryRunner.query(`DROP INDEX \`FK_3dfdc7a0491856457f8d6444293\` ON \`statistics\``);
        await queryRunner.query(`DROP INDEX \`idx_low_stock_by_user\` ON \`product\``);
        await queryRunner.query(`DROP INDEX \`FK_3e59a34134d840e83c2010fac9a\` ON \`product\``);
        await queryRunner.query(`DROP INDEX \`FK_b15422982adca3bf53adfb535de\` ON \`product\``);
        await queryRunner.query(`DROP INDEX \`FK_13e8b2a21988bec6fdcbb1fa741\` ON \`categories\``);
        await queryRunner.query(`DROP INDEX \`FK_45c0d39d1f9ceeb56942db93cc5\` ON \`user\``);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`telegramId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`telegramGroupId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX \`FK_45c0d39d1f9ceeb56942db93cc5\` ON \`user\` (\`createdById\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_13e8b2a21988bec6fdcbb1fa741\` ON \`categories\` (\`userId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_b15422982adca3bf53adfb535de\` ON \`product\` (\`unit_id\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_3e59a34134d840e83c2010fac9a\` ON \`product\` (\`user_id\`)`);
        await queryRunner.query(`CREATE INDEX \`idx_low_stock_by_user\` ON \`product\` (\`id\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_3dfdc7a0491856457f8d6444293\` ON \`statistics\` (\`product_id\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_5f282f3656814ec9ca2675aef6f\` ON \`sales\` (\`user_id\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_a0f1ebffae0628aae642b74d505\` ON \`sales\` (\`product_price_history_id\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_5015e2759303d7baaf47fc53cc8\` ON \`sales\` (\`product_id\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_9bbe39ab10e86530296c3340aa3\` ON \`product_price_history\` (\`product_id\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_745632f9034cd78ed2fbea6cd1a\` ON \`unit\` (\`userId\`)`);
    }
